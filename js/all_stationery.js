...
let stationery = document.getElementById("stationery_container");
let generate_stationery_shop = (sArr) => {
  return (stationery.innerHTML = sArr.map((x) => {
...
generate_stationery_shop(stationery_items_data);
...
for (let checkbox of checkboxes) {
  checkbox.addEventListener("click", function () {
    ...
    filterArray = stationery_items_data.filter((ele) => {
    ...
    generate_stationery_shop(filterArray);
